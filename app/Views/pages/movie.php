...
<?php $movieTmdbId = (int)($item['tmdb_id'] ?? $item['id'] ?? 0); ?>
...
<section class="v2-detail-hero has-inline-player movie-detail-hero">
  ...
  <div class="v2-detail-grid">
    ...
    <?php if ($movieTmdbId > 0): ?>
    <aside id="watch-player" class="v2-inline-player js-continue-media" data-media="<?= media_storage_payload($item, 'movie', url('movies/'.$item['slug'])) ?>">
      ...
      <div class="v2-player-frame v2-videasy-frame" style="position: relative; padding-bottom: 56.25%; height: 0;">
        <iframe
          src="https://player.videasy.net/movie/<?= e((string)$movieTmdbId) ?>"
          title="Movie player"
