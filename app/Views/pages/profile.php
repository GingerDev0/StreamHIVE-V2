<section class="profile-hero glass rounded-5 p-4 p-lg-5 mb-4">
  <div class="row g-4 align-items-center">
    <div class="col-lg-8">
      ...
      <p class="v2-lead mb-0">Bookmarks and continue watching are stored in this browser with localStorage, so the page updates instantly without an account.</p>
    </div>
    <div class="col-lg-4">
      <div class="profile-stats-grid">
        <div class="profile-stat"><strong data-profile-count="bookmarks">0</strong><span>Saved</span></div>
        <div class="profile-stat"><strong data-profile-count="continue">0</strong><span>Continue</span></div>
...
<section class="profile-section mb-5" data-profile-section="continue">
  <div class="v2-section-head compact">
    <div><span class="v2-section-eyebrow"><i class="fa-solid fa-circle-play"></i> Pick up where you left off</span><h2>Continue Watching</h2></div>
    <button class="btn btn-sm btn-outline-light js-profile-clear" type="button" data-clear="continue">Clear</button>
  </div>
  <div class="profile-grid" data-profile-grid="continue"></div>
  <div class="profile-empty glass rounded-4 p-4" data-profile-empty="continue">Open a movie or episode player and it will appear here.</div>
</section>
